...
This package is not supported on older Python versions and is supported and tested for versions 7 - 3.9.  It may work with other python versions but your mileage may vary.
