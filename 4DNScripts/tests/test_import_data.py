...
def test_dict_patcher_removes_empty_fields(file_metadata):
    post_json = imp.dict_patcher(file_metadata)
...
def test_dict_patcher_keeps_valid_fields(file_metadata):
    post_json = imp.dict_patcher(file_metadata)
