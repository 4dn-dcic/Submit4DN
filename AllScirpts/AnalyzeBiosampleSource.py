"""Track items throgh Biosample and Print Histogram for Sources in Biosamples.
...
'''
AllBioInRepUnique = pickle.load(open('EncodeMeta/BiosampleInRepUnique.p', 'r'))

# Get all sources from biosamples
...
plt.savefig('Figures/BiosampleSourceHist.ps')
'''
